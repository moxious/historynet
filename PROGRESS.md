...
**M13 Completion Notes (2026-01-18):**
- Application rebranded from "HistoryNet" to "Scenius" with new tagline "Mapping collective genius"
- Full light/dark theme system with URL parameter support (`?theme=dark`)
- Theme persists to localStorage as fallback when URL has no theme parameter
- All visualizations (graph, timeline) and UI components are theme-aware
- New favicon with interconnected nodes design (SVG)
